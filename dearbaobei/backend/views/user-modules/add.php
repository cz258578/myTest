    ...
    <div class="easyui-layout" fit="true" border="true">
        ...
        <div region="north" border="true" style="overflow:auto; padding:8px;height:328px; ">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="8">
              ...
              <tr>
                <td>控制器：</td>
                <td><input id="module_addr" name="module_addr" value="" class="easyui-textbox"></td>
                <td><span style="color:red;font-size:12px;" id="subject_password_text"></span></td>
              </tr>

              <tr>
                  <td>方法：</td>
                  <td><input id="action_addr" name="action_addr" class="easyui-textbox"></td>
                  <td valign="top"></td>
              </tr>
                ...
                <tr>
                    <td>可用角色层级：</td>
                    <td><select id="level" name="level" value="0" class="easyui-combobox" data-options="panelHeight:'auto'">
