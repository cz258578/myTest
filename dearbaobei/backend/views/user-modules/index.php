...
<div class="easyui-layout" fit="true">
    ...
    <div region="north" border="false" style="padding:10px;height:48px; padding-top:16px; padding-bottom:0px; overflow:hidden;">
        ...
        <div class="easyui-layout" fit="true" border="false">
            ...
            <div id="main_body_tool" region="west" style="width:188px; padding-right:18px;" border="false">
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" onclick="add()">新增模块</a>
            </div>
            <!--工具栏结束-->
                ...
                <div id="main_body_search" region="center" border="false" style="padding-left:26px;">筛选条件：
                    ...
                    <input id="name" value="" style="cursor:pointer;" class="easyui-textbox" data-options="prompt:'输入名称/控制器/方法'">
    ...
    <div region="center" border="false" id="main_body_datagrid" style="padding:8px; padding-bottom:0px;">
        ...
        <table id="tt" class="easyui-datagrid"
               data-options="url:'<?php echo \Yii::$app->urlManager->createUrl(['user-modules/infojson'])?>',fitColumns:true,fit:true,pagination:true,
            ...
            <tr>
                ...
                <th data-options="field:'module_addr',width:60">控制器</th>
                <th data-options="field:'action_addr',width:60">方法</th>
                <th data-options="field:'create_time_name',width:60">更新时间</th>
                <th data-options="field:'status_name',width:60">状态</th>
                <th data-options="field:'level',width:30">可用角色层级</th>
...
<script type="text/javascript">
    ...
    {
        var rs = '';
        rs += '<a onclick="addChildren('+index+');" class="easyui-linkbutton" style="cursor:pointer; color:#000000;">' +
            '<span class="l-btn-left l-btn-icon-left"><span class="l-btn-text">添加子类</span>' +
    ...
    function addChildren(index){
        ...
        title = '新增模块';
        callfun = 'callback';
        openTopWindow(url,title,508,398,callfun);
    }

    function add(){
        url = '<?php echo \Yii::$app->urlManager->createUrl(['user-modules/add'])?>';
        title = '新增模块';
        callfun = 'callback';
        openTopWindow(url,title,508,398,callfun);
    }
