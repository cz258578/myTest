    ...
    <div class="easyui-layout" fit="true" border="true">
        ...
        <div region="north" border="true" style="overflow:auto; padding:8px;height:328px; ">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                <tr>
                    <td width="23%">目录：</td>
                    <td><input id="parent_id" name="parent_id" value="" class="easyui-combotree" data-options="panelHeight:'auto',novalidate:true"></td>
                    <td width="36%">&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td>控制器：</td>
                    <td><input id="module_addr" name="module_addr" value="<?= $models->module_addr?>" class="easyui-textbox" required="true" data-options="novalidate:true"></td>
                    <td><span style="color:red;font-size:12px;" id="subject_password_text"></span></td>
                </tr>

                <tr>
                    <td>方法：</td>
                    <td><input id="action_addr" name="action_addr" value="<?= $models->action_addr?>" class="easyui-textbox"  required="true" data-options="novalidate:true"></td>
                    <td valign="top"></td>
                </tr>
