    ...
    <div class="easyui-layout" fit="true" border="true">
        ...
        <div region="north" border="true" style="overflow:auto; padding:8px;height:398px; ">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="8">
              ...
              <tr>
                <td>描述：</td>
                <td><input id="describe" name="describe" value="" class="easyui-textbox" required="true" data-options="novalidate:true"></td>
                <td><span>例： 状态类型</span></td>
              </tr>

              <tr>
                  <td>分组：</td>
                  <td><input id="group" name="group" class="easyui-combobox" data-options="panelHeight:'auto'"></td>
                  <td>例： 系统后台</td>
              </tr>
              ...
              <tr>
                ...
                <tr>
                <td valign="top">值：</td>
                <td><input id="value" name="value" class="easyui-textbox" style="height: 162px;"  data-options="multiline:true"></td>
