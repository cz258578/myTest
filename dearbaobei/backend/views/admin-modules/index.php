...
<div class="easyui-layout" fit="true">
    ...
    <div region="center" border="false" id="main_body_datagrid" style="padding:8px; padding-bottom:0px;">
        ...
        <table id="tt" class="easyui-datagrid"
               data-options="url:'<?php echo \Yii::$app->urlManager->createUrl(['admin-modules/infojson'])?>',fitColumns:true,fit:true,pagination:true,
...
<script type="text/javascript">
    ...
    function add(){
        url = '<?php echo \Yii::$app->urlManager->createUrl(['admin-modules/add'])?>';
        title = '新增模块';
        callfun = 'callback';
        openTopWindow(url,title,508,398,callfun);
    }
