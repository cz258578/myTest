...
<form id="ff" method="post" style="height:398px;" data-href="<?php echo \Yii::$app->urlManager->createUrl(['user-modules/save'])?>">
    <div class="easyui-layout" fit="true" border="true">
        ...
        <div region="north" border="true" style="overflow:auto; padding:8px;height:328px; ">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="8">
                ...
                <tr>
                    <td>控制器：</td>
                    <td><input id="module_addr" name="module_addr" value="<?= $models->module_addr?>" class="easyui-textbox"></td>
                    <td><span style="color:red;font-size:12px;" id="subject_password_text"></span></td>
                </tr>

                <tr>
                    <td>方法：</td>
                    <td><input id="action_addr" name="action_addr" value="<?= $models->action_addr?>" class="easyui-textbox"></td>
                    <td valign="top"></td>
                </tr>

                <tr>
                    <td>排序：</td>
                    <td><input id="sort" name="sort" value="<?= $models->sort?>" class="easyui-textbox"></td>
                    <td valign="top"></td>
                </tr>

                <tr>
                    <td>可用角色层级：</td>
                    <td><select id="level" name="level" value="<?= $models->level?>" class="easyui-combobox" data-options="panelHeight:'auto'">
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input name="is_show" <?= $models->is_show==1?'checked':''?> type="radio" value="1" > 显示
                            <input name="is_show" <?= $models->is_show==0?'checked':''?> type="radio" value="0" > 隐藏
                        </label>
                    </td>
                    <td valign="top"></td>
                </tr>
...
<script type="text/javascript">
    ...
    $(function(){
        $('#parent_id').combotree({
            url:'<?= yii::$app->urlManager->createUrl(['user-modules/get-parent-list'])?>',
            valueField:'id',
            textField:'text',
            editable:false,
            required:true,
            ...
            onLoadSuccess:function(){
                $('#parent_id').combotree('setValue', <?= $models->parent_id?>);
            }
        })
    })
